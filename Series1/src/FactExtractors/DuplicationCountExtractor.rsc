...
public int ExtractDuplicateCountTest2()
{
 	loc project=|project://Test2|;
  	//loc project=|project://SmallSql|;
  	str ext="java";
	return 	ExtractDuplicateCount(GetAllFiles(project,ext));
}

public int ExtractDuplicateCountTestJ()
{
...
public int ExtractDuplicateCountOW(loc project, str ext)
{
	return 	ExtractDuplicateCount(GetAllFiles(project,ext));
}

public int ExtractDuplicateCountSmallSql()
{
	loc project=|project://SmallSql|;
  	str ext="java";
	return 	ExtractDuplicateCount(GetAllFiles(project,ext));
